...
console.log(isDotSeparatedIpAddress('2.34.24')) // false
console.log(isDotSeparatedIpAddress('2.34.24.3')) // true
console.log(isDotSeparatedIpAddress('2.34.24.we')) // false
console.log(isDotSeparatedIpAddress('2.34.24.42.42.43')) // false
